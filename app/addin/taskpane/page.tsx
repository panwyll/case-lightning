...
// surfaces render the same thing from one source.
            ...
            <>
              ...
              {(() => {
                ...
                const row = (w: WorklistEntry) => {
                  ...
                  // Snooze: three z's floating up and to the right, like 💤.
                  const iClock = (
                    <span style={{ display: 'inline-flex', alignItems: 'flex-end', lineHeight: 1, fontWeight: 800, fontStyle: 'italic', letterSpacing: -0.5, fontFamily: 'system-ui, sans-serif' }}>
                      <span style={{ fontSize: 7 }}>z</span>
                      <span style={{ fontSize: 10, marginBottom: 3 }}>z</span>
                      <span style={{ fontSize: 13, marginBottom: 6 }}>z</span>
                    </span>
                  );
          ...
          {tab === 'house' && matterInfo?.matter && (
            <>
              <HousePanel
                ...
                stages={stageOpts}
              />
              <ContactsPanel key={`contacts-${matterInfo.matter.id}`} matterId={matterInfo.matter.id} initial={matterInfo.contacts ?? []} api={api} />
