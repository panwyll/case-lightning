...
export default function AdminPage() {
  ...
  const navGroupLabel: React.CSSProperties = { fontSize: 10, fontWeight: 700, letterSpacing: 1.2, textTransform: 'uppercase', color: '#9aa6b8', padding: '0 4px 2px', marginBottom: 2, borderBottom: '1px solid #eef1f5' };
