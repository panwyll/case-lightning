...
export const COMMAND_SPECS: CommandSpec[] = [
  ...
  { type: 'proof_of_funds_submitted', actor: 'automation', stages: ['instruction', 'pre_contract', 'contract_review', 'pre_exchange'], emits: ['proof_of_funds_submitted'], description: 'The client submitted: typed facts, rule flags, the declaration document, and a decision for the conveyancer.' },
...
export const EVENTUALITIES: EventualitySpec[] = [
  ...
  { area: 'shape', scenario: 'Gifted deposit / source of funds', handling: 'built', mechanism: 'proof-of-funds form → rule flags → briefing → sign-off decision; sign-off closes source_of_funds issues and tells the lender of a gift; issue source_of_funds for anything outside the form' },
