...
export const STAGE_SPECS: StageSpec[] = [
  ...
  { id: 'pre_contract', label: 'Pre-contract', purpose: 'Searches ordered automatically on entry; enquiries raised; the mortgage offer checked.', gates: ['every required search ordered and resolved', 'every enquiry replied and resolved (or withdrawn)', 'mortgage offer resolved (lender-funded purchases)'], gateKeywords: ['search'], subflows: ['search', 'enquiry', 'mortgage'], typical: ['raise_enquiry', 'record_search_ordered', 'search_returned', 'mortgage_offer_received', 'withdraw_enquiry', 'set_target_dates'] },
...
export const COMMAND_SPECS: CommandSpec[] = [
  ...
  { type: 'raise_enquiry', actor: 'either', stages: ['pre_contract', 'contract_review', 'pre_exchange', 'exchanged', 'pre_completion', 'completed', 'post_completion'], emits: ['enquiry_raised'], description: 'An enquiry to the other side (external, or internal across the wall).' },
